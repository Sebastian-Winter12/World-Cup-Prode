...
export const GetGroupLeaderboardResponse = zod.array(
  GetGroupLeaderboardResponseItem,
);
...
export const GetUpcomingMatchesResponse = zod.array(
  GetUpcomingMatchesResponseItem,
);
