 ...
 */
export const listMyGroups = async ( options?: RequestInit): Promise<GroupWithMeta[]> => {
 ...
 */
export const listMatches = async (params?: ListMatchesParams, options?: RequestInit): Promise<MatchWithPrediction[]> => {
 ...
 */
export const getMatch = async (matchId: number, options?: RequestInit): Promise<MatchWithPrediction> => {
 ...
 */
export const updateMatchScore = async (matchId: number,
    scoreUpdate: ScoreUpdate, options?: RequestInit): Promise<Match> => {
...
export const getUpdateMatchScoreMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateMatchScore>>, TError,{matchId: number;data: BodyType<ScoreUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateMatchScore>>, TError,{matchId: number;data: BodyType<ScoreUpdate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateMatchScore>>, {matchId: number;data: BodyType<ScoreUpdate>}> = (props) => {
 ...
 */
export const upsertPrediction = async (matchId: number,
...
export const getUpsertPredictionMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof upsertPrediction>>, TError,{matchId: number;data: BodyType<PredictionInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof upsertPrediction>>, TError,{matchId: number;data: BodyType<PredictionInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof upsertPrediction>>, {matchId: number;data: BodyType<PredictionInput>}> = (props) => {
          const {matchId,data} = props ?? {};
 ...
 */
export const getGroupLeaderboard = async (groupId: number, options?: RequestInit): Promise<LeaderboardEntry[]> => {
...
export const getGetGroupLeaderboardQueryOptions = <TData = Awaited<ReturnType<typeof getGroupLeaderboard>>, TError = ErrorType<unknown>>(groupId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getGroupLeaderboard>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetGroupLeaderboardQueryKey(groupId);
   ...
   return  { queryKey, queryFn, enabled: !!(groupId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getGroupLeaderboard>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetGroupLeaderboard<TData = Awaited<ReturnType<typeof getGroupLeaderboard>>, TError = ErrorType<unknown>>(
 groupId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getGroupLeaderboard>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const getLiveMatches = async ( options?: RequestInit): Promise<MatchWithPrediction[]> => {
 ...
 */
export const getUpcomingMatches = async ( options?: RequestInit): Promise<MatchWithPrediction[]> => {
...
export const getGetUpcomingMatchesQueryOptions = <TData = Awaited<ReturnType<typeof getUpcomingMatches>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getUpcomingMatches>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetUpcomingMatchesQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getUpcomingMatches>>> = ({ signal }) => getUpcomingMatches({ signal, ...requestOptions });
...
export function useGetUpcomingMatches<TData = Awaited<ReturnType<typeof getUpcomingMatches>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getUpcomingMatches>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
